    ...
    <Container maxW="container.md" width="100%" flexGrow={1}>
      ...
      >
        ...
        <Text as="div" my={4} color="whiteAlpha.700">
          ...
          microntroladores a bajo nivel, flujos de trabajo en equipo basados en
          el sistema control de versiones Git, y la gestion ágil de proyectos.
        </Text>
      ...
      <Box my={{ base: 16, sm: 32 }}>
        ...
        >
          ...
          <Flex as="li">
            ...
            <Text as="div" fontSize="sm">
              Metodología basada en la práctica que obliga a interactuar con el
              entorno y adaptarse a él con el objetivo de lograr un aprendizaje
              más eficaz y con mejores resultados.
            </Text>
          </Flex>
          <Flex as="li">
          ...
          <Flex as="li">
            ...
            <Text as="div" fontSize="sm">
              ...
              los sistemas embebidos. Su madurez y alta presencia en el ámbito,
              los hacen indispensables en el portafolios de un profesional en la
          ...
          <Flex as="li">
            ...
            <Text as="div" fontSize="sm">
              Gestión iterativa que permite la entrega continua y la integración
              de la retroalimentación del entorno. <i>Learning-by-doing</i>: se
              utiliza la gestión ágil para el propio desarrollo de la
              asignatura.
            </Text>
          </Flex>
        </Flex>
          ...
          >
            ...
            <Box>
              <Text mt={0}>
                ...
                rango de medición de corriente que va de los 65 mA hasta 1 &mu;A
                en un rango de tensión de &plusmn;3.3 V.
              </Text>
              <Text mb={0}>
                ...
                para el desarrollo de dispositivos de detección y diagnóstico de
                enfermedades.{' '}
